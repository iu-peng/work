...
var yesorno = $('.yesorno')[0];
yesorno.style.left = (document.documentElement.clientWidth - yesorno.offsetWidth)/2  + 'px';
yesorno.style.top = (document.documentElement.clientHeight - yesorno.offsetHeight)/2  + 'px';
...
var moveChooseIndex = null;//选中的span的dataindex
...
function showmove(dataspanN){
	...
	//取消按钮
	moveno.onclick = document.onclick = function(){
		mTween(moveshow,{zIndex:-1},10,'linear',function(){
			said('movewarn2')
		})
	}
